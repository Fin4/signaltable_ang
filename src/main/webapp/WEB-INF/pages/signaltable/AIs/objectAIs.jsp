    ...
    <table>
        ...
        <tr><th colspan="2">Аналоговые входы</th>
            <th class="tablemenu">
                ...
                <a href="<c:url value='/${apcsObject.name}/ai/new'/>" class="mbutton">add new</a>
            </th>
        </tr>
        <tr>
            <th>ID</th>
        ...
        <c:forEach items="${analogInputs}" var="analogInput">
            <tr>
                <td>${analogInput.id} <a href="<c:url value='/${apcsObject.name}/ai/${analogInput.id}-edit'/>" class="button">edit</a>
                    <c:url var="deleteURL" value='/${apcsObject.name}/ai/${analogInput.id}-delete'/>
